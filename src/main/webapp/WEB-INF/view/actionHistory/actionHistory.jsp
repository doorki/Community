   ...
   $().ready(function(){
	   ...
	   $("#endDateYear, #endDateMonth").change(function(){
		  ...
		  if( data.attr("id") == "endDateYear"){
			  var year = data.val();
			  var month = $("#endDateYear").val();
		  }else{
			  var year = $("#endDateYear").val();
			  var month = data.val();
		  }
			$.post("<c:url value="/api/date/max/{year}/{month}"/>" + year +"/"+ month ,{}, 
					function(response){
...
<body>
   ...
   <form id="searchForm">
      ...
      <div>
         IP : <input type="text" id="ip" value="ip"/>
      </div>
      <div>
         Email : <input type="text" id="email" value="email"/>
      </div>
      <div>
         LOG : <input type="text" id="log" value="log"/>
      </div>
      <div>
         AS IS : <input type="text" id="asIs" value="asIs"/>
      </div>
      <div>
         TO BE : <input type="text" id="toBe" value="toBe"/>
      </div>
      <div>
         기간 : 
